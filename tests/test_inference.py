...
from mediasent.inference import (
...
from mediasent.preprocessing import ModelConfig, register_model
...
def test_create_prompt():
    ...
    with patch("tbainvestetl.utils.aws.get_s3_file") as mock_get_s3_file:
        ...
        mock_get_s3_file.assert_called_once_with("mediasent/config/prompt_template.txt")
...
def ntest_save_sentiment_results_integration(sql):
    ...
    web_url = (
        "https://www.nytimes.com/2012/01/02/technology/"
        "google-hones-its-advertising-message-playing-to-emotions.html"
    )
...
def test_load_hyperparameters():
    ...
    with patch("mediasent.inference.load_config") as mock_load_config:
