...
def create_pipeline(
    ...
    code_prefix = "mediasent/code"
    processing_output_path = f"s3://{bucket}/mediasent/processing/output"
    transform_output_path = f"s3://{bucket}/mediasent/transform/output"
    ...
    # Load config
    config = json.loads(aws.get_s3_file("mediasent/config/model_config.json"))
