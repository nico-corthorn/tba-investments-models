...
from tbainvestetl.utils import aws, sql_manager
from tqdm import tqdm
from transformers import AutoModelForCausalLM, AutoTokenizer

from mediasent.preprocessing import generate_model_id, load_config
...
def create_prompt(headline, snippet):
    ...
    prompt_template = aws.get_s3_file("mediasent/config/prompt_template.txt")
